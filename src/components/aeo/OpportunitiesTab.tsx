                    ...
                    <CardContent className="space-y-4">
                        <div className="bg-background rounded-lg p-4 border shadow-sm text-sm space-y-3">
                            ...
                            <p className="leading-relaxed">
                                "Hi Team,<br/><br/>I noticed your recent article on AEO tools cited legacy softwares but missed the modern stack. We recently launched FUPilot, which is currently dominating Perplexity charts for 'programmatic seo'.<br/><br/>Would you be open to an addendum?"
                            </p>
                        </div>
