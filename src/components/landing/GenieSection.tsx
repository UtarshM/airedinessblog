            ...
            <div className="container mx-auto px-4 md:px-8">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 relative flex justify-center items-center">
                        ...
                        <div className="absolute top-0 md:top-10 -right-4 md:-right-10 glass-card border-2 border-[#00FF66]/30 p-4 rounded-2xl shadow-2xl max-w-xs animate-bounce duration-[4000ms] z-20 hidden sm:block">
                            <p className="text-sm font-semibold text-[#00FF66] mb-1">Onboarding Complete! 🤖</p>
                            <p className="text-xs text-muted-foreground leading-relaxed">I've assigned your Marketing, Sales, and Analytics agents. They're already analyzing your competitor strategies.</p>
