    ...
    const steps = [
        {
            ...
            description: "Connect your branding, keywords, and goals. Select the specialized agents needed to execute your strategy (Brand, Social, Digital)."
        },
        {
            number: "02",
            title: "Autonomous Execution",
            description: "Your agents work in the background 24/7—conducting research, generating content, and mastering your brand voice across channels."
        },
        {
            number: "03",
            title: "Approve & Scale",
            description: "Review high-quality outputs on your command center. One-click publish to your platforms and watch your brand presence scale."
        }
    ];
                ...
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <p className="text-lg text-muted-foreground mb-8">
                            Stop manual labor. Deploy your agents and let them handle the heavy lifting while you focus on vision and strategy.
                        </p>
