                ...
                <section className="text-center space-y-8">
                    <div className="space-y-4 max-w-4xl mx-auto">
                        ...
                        <p className="text-gray-400 text-xl max-w-3xl mx-auto">
                            Welcome to the heart of FUPilot – your personal team of AI marketing experts. Each member is a fusion of cutting-edge AI and deep industry knowledge, tailored to autonomously revolutionize your brand's presence.
                        </p>
                    </div>
                </section>
